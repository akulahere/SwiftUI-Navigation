...
`examples/swiftui-navigation-example/`

2. Code-first starter templates (copy/paste into a new app):
`navigation-how-to/starter-code/`

3. Short index for starter templates:
`navigation-how-to/README.md`

Quick start for this repository:

1. Open `examples/swiftui-navigation-example/SwiftUI-Navigation-PoC.xcodeproj`.
2. Run scheme `SwiftUI-Navigation-PoC`.
3. Use `navigation-how-to/starter-code/Navigation/` as a bootstrap for new projects.
